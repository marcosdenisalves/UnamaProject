...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		Avaliacao av2 = new Avaliacao(null, 5, "Excelente conteudo", LocalDate.parse("01/05/2015", formatter).atStartOfDay(), user2, lab2);
		Avaliacao av3 = new Avaliacao(null, 3, "Boa galera, gostei demais!", LocalDate.parse("01/10/2021", formatter).atStartOfDay(), user3, lab3);
